  ...
  <div class="wrapper">
          ...
          <div class="row latest-job margin-top-50 margin-bottom-20 bg-white">
            ...
            <form method="post" id="registerCandidates" action="adduser.php" enctype="multipart/form-data">
              ...
              <div class="col-md-6 latest-job ">
                ...
                <div class="form-group">
                  <input class="form-control input-lg" type="tel" id="contactno" name="contactno" minlength="10" maxlength="10" required onkeypress="return validatePhone(event);" placeholder="Phone Number *">
                </div>
                <div class="form-group">
    ...
    <footer class="main-footer" style="margin-left: 0px;">
      <div class="text-center">
        <strong>Copyright &copy; 2024 <a href="#">SIOM Placement Assistant</a>.</strong> All rights
        reserved.
      </div>
    </footer>
