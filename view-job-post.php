  ...
  <div class="wrapper">
    ...
    <footer class="main-footer" style="margin-left: 0px;">
      <div class="text-center">
        <strong>Copyright &copy; 2024 <a href="learningfromscratch.online">SIOM Placement Assistant</a>.</strong> All rights
        reserved.
      </div>
    </footer>
