...
//
// *** To Email ***
$to = 'mail.automatedplacementsystem@gmail.com,' . $email;
//
// *** Subject Email ***
$subject = 'New Contact Form Submitted -  Subject : ' . $sub;
//
// *** Content Email ***
$content = "From : " . $name . "\n" . "Email : " . $email . "\n" . "Message : " . $message . "\nThank you for contacting us!\nOur team will respond to your query, feedback soon!\nFor any queries you can contact T/P Cell on mail.automatedplacementsystem@gmail.com\n\nRegards,\nMail Team, Automated Placement System";
//
//*** Head Email ***
$headers = "From:" . $email . "\r\n";
//
