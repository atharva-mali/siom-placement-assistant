		...
		if ($course1 == $course2) {
			...
			if ($result1->num_rows == 0) {
				...
				if ($conn->query($sql) === TRUE) {
					...
					$to = $row1['email'];
					//Subject
					$subject = "Job Application Successful | SIOM Placement Assistant";
					//Conttent
					...
					$message .= "SIOM Placement Assistant Team";
					//Message Headers
					$headers = "From: mail.siomplacementassistant@gmail.com\r\n";
					$headers .= "Reply-To: mail.siomplacementassistant@gmail.com\r\n";
