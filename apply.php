		...
		if ($course1 == $course2) {
			...
			if ($result1->num_rows == 0) {
				...
				if ($conn->query($sql) === TRUE) {
					// Send email to user on successful job application
					$to = $row1['email'];
					//Subject
					$subject = "Job Application Successful | Automated Placement System";
					//Conttent
					$message = "Dear " . $row1['firstname'] . ",\n\n";
					$message .= "Your job application for the position at " . $row['jobtitle'] . " has been successfully received.\n";
					$message .= "We will review your application and get back to you shortly.\n\n";
					$message .= "Thank you for your interest.\n\n";
					$message .= "Best regards,\n";
					$message .= "Automated Placement System Team";
					//Message Headers
					$headers = "From: mail.automatedplacementsystem@gmail.com\r\n";
					$headers .= "Reply-To: mail.automatedplacementsystem@gmail.com\r\n";
