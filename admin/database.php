                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col md-13">
                            ...
                            $sql1 = "SELECT DISTINCT job_post.jobtitle
                            FROM job_post
                            ...
                            ORDER BY job_post.jobtitle ASC;
                            ";
                            ...
                            <form method="POST">
                                <div class="form-group text-center option">
                                    ...
                                    <input name="submit" type="submit" value="Submit" style="margin-top: 5px;" class="btn btn-success">
