...
<body class="hold-transition skin-green sidebar-mini">
            ...
            <section id="candidates" class="content-header">
                <div class="container">
                    ...
                    <div class="col md-4">
                        ...
                        <h3>Filters</h3>
                        <div class="newRow" style="flex-direction: row; display: flex;">
                            <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for names..">
                            <input type="text" id="myInput2" onkeyup="myFunction2()" placeholder="Search by company..">
                        </div>
                        ...
                        <!-- <button type="submit1" onclick="allFilterApply()" name='all-filter-btn' style="margin-left: 8px;" class="btn btn-success">Apply All Filters</button> -->
                        <input type="text" id="myInput3" onkeyup="myFunction3()" placeholder="Search by Year" style="margin-left: 8px;">
                        <input type="text" id="myInput4" onkeyup="myFunction4()" placeholder="Search by Department.." style="margin-left: 8px;">
                        <a href="summary.php"><button type="submit1" name='summary_btn' class="btn btn-primary">Get Placement Summary</button></a>
                    </div>
  ...
  height: 50px; position:relative; background-color:#1f0a0a; color:white;">
        ...
        <strong>Copyright &copy; 2023 <a href="http://localhost/Placement-Portal-new/">SIOM Placement Assistant</a>.</strong> All rights
            reserved.
        </div>
    </footer>
